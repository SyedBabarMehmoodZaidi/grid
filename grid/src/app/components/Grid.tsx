...
const grid = () => {
  return (
    <div className='grid grid-cols-4 grid-rows-5 h-screen gap-2 p-2'>
    ...
    <div className='bg-red-700 text-white flex justify-center items-center col-span-1'>Content 2</div>
    <div className='bg-red-700 text-white flex justify-center items-center col-span-1'>Content 3</div>
